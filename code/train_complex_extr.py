...
def main(args):
    ...
    train_dataset = PointCloudEmbeddingSequenceDataset(DATA_DIR, 'train', use_normals=False)
    train_dataloader = DataLoader(train_dataset, batch_size = batch_size, num_workers = num_workers, shuffle = True) 
    val_dataset = PointCloudEmbeddingSequenceDataset(DATA_DIR, 'validation', use_normals=False)
